...
func init() {
	queryCmd.Flags().String("db", defaultDBPath, "Path to BadgerDB directory")
	queryCmd.Flags().String("workspace", "", "Workspace name to query by merging per-repo databases")
}
